        ...
        <div class="importance">
          <div class="table">
            ...
            >
              ...
              <el-table-column prop="pdjb" label="风险程度" align="center">
              </el-table-column>
              <el-table-column prop="pddj" label="风险等级" align="center">
              </el-table-column>
            </el-table>
          </div>
          <div class="button">
...
<script>
import { hz, downfile } from "api/jsfxpg";
export default {
  data() {
    return {
      id: "",
  ...
  methods: {
    ...
    hz() {
      ...
      hz(this.id).then((res) => {
        ...
        this.tableData[0].pdjb = this.tableData[0].pddj.slice(0,1)
        this.tableData[0].pddj = this.tableData[0].pddj.slice(2)
      });
    },
  },
  mounted() {
