<template>
  <div id="riskAssessment">
    ...
    <div class="risk">
      ...
      <div class="search">
        <el-form :inline="true" :model="searchFrom" class="demo-form-inline" id="gjjs">
          ...
          <el-col :span="7" :xs="24" :sm="10" :md="10" :lg="24">
          ...
          <el-form-item label="">
            <span>关键技术：</span>
            <el-button class="generalButton" icon="el-icon-plus" @click="open"
              >选择</el-button
            >
            <span>评估准则：</span>
...
<script>
import { getgjjs } from "api/jssgl";
import serviceDialog from "components/evaluationManager/startAssess/step/serviceDialog.vue";
import { getjssgl } from '../../../api/jssgl';
export default {
  components: {
    serviceDialog,
  },
