        ...
        <div class="table">
            <el-alert
             ...
             <el-table
                ...
                <el-table-column
                prop="ProjectName"
                label="合同甲方" align="center"
                >
                </el-table-column>
                <el-table-column
                prop="work"
                label="合同乙方" align="center"
                >
                </el-table-column>
                <el-table-column
                prop="note"
                ...
                <el-table-column
                prop="projectPerpon"
                label="项目负责人" align="center"
                >
                </el-table-column>
                <el-table-column
                prop="data"
                label="签约日期" align="center"
                >
                </el-table-column>
                <el-table-column
                prop="belongs"
                label="所属课题" align="center"
                >
                </el-table-column>
                ...
                <template>
                    ...
                    <div style="display:flex;flex-direction: column;align-items: center;justify-content: center;">
                        ...
                        <el-button type="text" style="color:#000" @click="managementBtn">经费管理</el-button>
